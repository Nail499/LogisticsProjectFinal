...
// Dispetçer "Ödənişlər" — Admin-in eyni siyahısı (bax
// DispatcherPaymentController, AdminPayments.jsx — eyni sətir forması,
// sadəcə Excel ixracı admin-ə xasdır, burada yoxdur), + hər sətirdə
// fakturaya baxmaq üçün "Bax" düyməsi (bax InvoiceView.jsx — üç roldan da
// eyni komponent istifadə olunur).
export default function DispatcherPayments() {
  ...
  useEffect(() => {
    axiosClient.get('/api/dispatcher/payments')
  ...
  return (
    <div>
      ...
      {invoicePaymentId && (
        <InvoiceView apiUrl={`/api/dispatcher/payments/${invoicePaymentId}/invoice`} onClose={() => setInvoicePaymentId(null)} />
      )}
    </div>
  );
}
